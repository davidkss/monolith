[![Build Status](https://dev.azure.com/admin20046/admin2dev/_apis/build/status/admin2dev-CI?branchName=master)](https://dev.azure.com/admin20046/admin2dev/_build/latest?definitionId=1&branchName=master)
